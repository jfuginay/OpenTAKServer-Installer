...
echo "${GREEN} Installing OpenTAKServer from local federation branch...${NC}"
...
# Install OpenTAKServer from local repo
...
echo "${GREEN}Building OpenTAKServer-UI from federation branch...${NC}"
...
sudo cp -r dist/* /var/www/html/opentakserver/
